...
def precision_at_k(r, k):
    ...
    Parameters
    ----------
    r : List, list of the rank_ctr items
    k : int, top-K number
...
def recall_at_k(rs, test_ur, k):
    ...
    Parameters
    ----------
    rs : Dict, {user : rank_ctr items} for test set
...
def ap(r):
    ...
    Parameters
    ----------
    r : List, Relevance scores (list or numpy) in rank_ctr order (first element is the first item)
...
def dcg_at_k(r, k):
    ...
    Parameters
    ----------
    r : List, Relevance scores (list or numpy) in rank_ctr order
